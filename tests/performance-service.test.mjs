...
const {buildDailyPerformance,PERFORMANCE_CALCULATION_VERSION}=loadTypescript('src/lib/performance.ts');
...
test('shared history performs one read/calculation/save and reuses only a verified finalized prefix',async(t)=> {
 const saved={calculationVersion:PERFORMANCE_CALCULATION_VERSION,revision:'r1',startedAt:tx.createdAt,points:[point('2020-01-01'),point('2020-01-02')],serverSynced:true};
