...
export function loadTypescript(path, overrides={}, cache=new Map()) {
  ...
  runInNewContext(outputText,{exports,require:localRequire,process:{env:{}},console,Date,Intl,Map,Set,Promise,JSON,Number,Object,Array,Math,Error,TypeError,RangeError,DOMException,AbortController,AbortSignal,URL,URLSearchParams,TextEncoder,TextDecoder,structuredClone,crypto:globalThis.crypto,setTimeout,clearTimeout,setInterval,clearInterval,fetch:(...args)=>globalThis.fetch(...args)}, {filename:absolute});
  return exports;
}
