...
| 보유자산·거래 저장 | [자산 배치](./PRODUCT_SPEC.md#내-포트폴리오-배치), [저장·복구](./PRODUCT_SPEC.md#거래-저장동기화복구) | [유형별 화면](./DESIGN_SYSTEM.md#기능-유형별-화면-기준) | [portfolio](./src/features/portfolio), [보유자산](./src/app/portfolio/page.tsx), [자산 요약](./src/components/PortfolioMetrics.tsx), [공개 훅](./src/hooks/usePortfolio.tsx), [명령](./src/features/portfolio/model/commands.ts), [저장 큐](./src/features/portfolio/data/ledger-store.ts) | [저장](./tests/ledger-store.test.mjs), [SQL](./tests/sql-ledger.test.mjs), [백업](./tests/backup-commands.test.mjs), [빈 상태·문구](./tests/screen-copy.test.mjs) |
